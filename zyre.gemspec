# -*- encoding: utf-8 -*-
# stub: zyre 0.1.0.pre.20201007141245 ruby lib

Gem::Specification.new do |s|
  s.name = "zyre".freeze
  s.version = "0.1.0.pre.20201007141245"

  s.required_rubygems_version = Gem::Requirement.new("> 1.3.1".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://todo.sr.ht/~ged/rbzyre/browse", "changelog_uri" => "https://deveiate.org/code/rbzyre/History_md.html", "documentation_uri" => "https://deveiate.org/code/rbzyre", "homepage_uri" => "https://hg.sr.ht/~ged/rbzyre", "source_uri" => "https://hg.sr.ht/~ged/rbzyre/browse" } if s.respond_to? :metadata=
  ...
  s.homepage = "https://hg.sr.ht/~ged/rbzyre".freeze
